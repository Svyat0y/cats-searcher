...
const VotingMessages: React.FC = () => {
	return (
		<div className={ s.voting__messages }>
			<div className={ s.voting__message_wr }>
				<span className={ s.voting__time }>22:35</span>
				<span className={ s.voting__desc }>
							Image ID: <span className={ s.id_desc }>fQSunHvl8</span> was added to Favourites
						</span>
