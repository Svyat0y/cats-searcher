...
import SearchPanelIcon  from './SearchPanelIcon'
...
const SearchPanelButtons: FC = () => {
	...
	return (
		<div className={ s.icons }>
			<SearchPanelIcon route={ 'likes' } page={ likePage } location={ locLikes }>
			...
			<SearchPanelIcon route={ 'favourites' } page={ favPage } location={ locFav }>
			...
			<SearchPanelIcon route={ 'dislikes' } page={ 0 } location={ locDislikes }>
				<svg width='30' height='30' viewBox='0 0 30 30' fill='none' xmlns='http://www.w3.org/2000/svg'>
					<path
